...
`live-agent:events:{interview_id}` — единственный получатель на другой стороне (backend,
`specs/004-candidate-interview-flow/contracts/control-channel.md`) сам решает, что из
этого показать кандидату; live-agent никакой UI-семантики не знает и знать не должен.

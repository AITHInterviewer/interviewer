 ...
 * устройств — один экран (`setup`), не два последовательных шага — микрофон
 * запрашивается только по явному клику внутри `DeviceCheck` (FR-001: до подтверждения
 * согласия — доступ не запрашивается), камера опциональна и отказ не блокирует
 * переход. Кандидату не нужно отдельно "переходить" между согласием и проверкой
 * устройств. Дальше — сам interview-room ("ready").
 */
